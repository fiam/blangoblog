...
DATABASE_NAME = 'blango'             # Or path to database file if using sqlite3.
DATABASE_USER = 'fiam'             # Not used with sqlite3.
...
SECRET_KEY = '4#h)^hn&4!i(y9$b@2d7k#6a0foaxa6$@#)@+q$d64au@3p$a3'
